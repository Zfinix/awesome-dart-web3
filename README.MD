...
### Libraries
  ...
  * [capsule](https://pub.dev/packages/capsule) - [Capsule](https://usecapsule.com/) is a cross app embedded wallet solution for Ethereum and Cosmos chains using emails/social login and Passkeys.
